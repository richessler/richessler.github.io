...
module.exports = function (grunt) {
  ...
  Object.keys(configBridge.paths).forEach(function (key) {
    configBridge.paths[key].forEach(function (val, i, arr) {
      arr[i] = path.join('./docs/old_site_assets', val);
    });
  });
  ...
  grunt.initConfig({
    ...
    jscs: {
      ...
      assets: {
        ...
        src: ['docs/old_site_assets/js/src/*.js', 'docs/old_site_assets/js/*.js', '!docs/old_site_assets/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      docsJs: {
        ...
        dest: 'docs/old_site_assets/js/docs.min.js'
      }
    },
    ...
    postcss: {
      ...
      docs: {
        ...
        src: 'docs/old_site_assets/css/docs.min.css'
      },
      examples: {
        options: {
          processors: [
    ...
    cssmin: {
      ...
      docs: {
        src: 'docs/old_site_assets/css/docs.min.css',
        dest: 'docs/old_site_assets/css/docs.min.css'
      }
    },
    ...
    csscomb: {
      ...
      docs: {
        src: 'docs/old_site_assets/css/src/docs.css',
        dest: 'docs/old_site_assets/css/src/docs.css'
      }
    },
    ...
    watch: {
      ...
      docs: {
        files: 'docs/old_site_assets/scss/**/*.scss',
        tasks: ['dist-css', 'docs']
      }
    },
